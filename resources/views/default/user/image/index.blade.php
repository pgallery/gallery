...
<div class="page-header">
  <h2>{{ $thisAlbum->name }}  @if(Auth::check())<a href="{{ route('zip-album', ['url' => $thisAlbum->url]) }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a>@endif</h2>
