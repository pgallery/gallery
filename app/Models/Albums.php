...
class Albums extends Model
{
    ...
    public function http() {
        return Cache::remember('albums.http_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return env('APP_URL') . "/" . $this->url;
        });        
    }
    
    public function path() {
        return Cache::remember('albums.path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return \Setting::get('upload_dir') . "/" .  $this->directory;
        });
    }

    public function http_path() {
        return Cache::remember('albums.http_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return env('APP_URL') . "/images/original/" . $this->url;
        });
    }
    
    public function thumb_path() {
        return Cache::remember('albums.thumb_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return \Setting::get('thumbs_dir') . "/" .  $this->directory;
        });
    }

    public function http_thumb_path() {
        return Cache::remember('albums.http_thumb_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function() {
            return env('APP_URL') . "/images/thumb/" . $this->url;
        });
    }
    
    public function mobile_path() {
        return Cache::remember('albums.mobile_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return \Setting::get('mobile_upload_dir') . "/" .  $this->directory;
        });
    }

    public function http_mobile_path() {
        return Cache::remember('albums.http_mobile_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
            return env('APP_URL') . "/images/mobile/" . $this->url;
        });
    }
    
    public function category() {
        return Cache::remember('albums.category_' . $this->categories_id . '_cache', Setting::get('cache_ttl'), function(){
    ...
    public function imagesCount() {
        return Cache::remember('albums.imagesCount_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
    ...
    public function owner() {
        return Cache::remember('albums.owner_' . $this->users_id . '_cache', Setting::get('cache_ttl'), function(){
    ...
    public function thumbs_http_path() {
        return Cache::remember('albums.thumbs_http_path_' . $this->id . '_cache', Setting::get('cache_ttl'), function(){
